...
class test {
    public static void main(String args[]) throws Exception {
        ...
        System.out.println("Want to auto commit y|n:");
...
class Operation {
    ...
    {   
        Scanner in = new Scanner(System.in);
        boolean bool = cn.getAutoCommit();
        if(bool==false){
            System.out.println("Want commit change y|n: ");
            String x= in.nextLine();
            if(x.equals("y")){
                cn.commit();
                System.out.println("Change save successfully");
            }else{
                cn.rollback();
                System.out.println("Change is rollback");
            }
        }
